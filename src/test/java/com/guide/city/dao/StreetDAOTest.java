...
public class StreetDAOTest {
    ...
    public StreetEntity getEntity() throws IOException, JSONException {
        StreetEntity entity = new StreetEntity(5);
        entity.setName("улица Бевза");
        entity.setFormattedAddress("улица Бевза, Винница, Винницкая область, Украина");
        entity.setInformation("На честь Бевза, нашего любимого преподавателя");
